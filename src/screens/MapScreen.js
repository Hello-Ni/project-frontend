...
export default function MapWindow({navigation}) {
    ...
    const submitHandler=async()=>{
        ...
        .then(async (json) => {
          ...
          let Loc={latitude:searchLoc.lat,longitude:searchLoc.lng,latitudeDelta:0.02,longitudeDelta:0.02};
          setInputLoc(Loc)
    ...
    <TouchableWithoutFeedback onPress={()=>{
      ...
      <View style={styles.container}>
        ...
        {animalDetail.showing && <View style={styles.detailBox}>
          <Image style={styles.photo} source={require('../../assets/dog.jpg')} />
          <View>
